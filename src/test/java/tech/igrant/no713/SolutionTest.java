...
public class SolutionTest {
    ...
    private static class TestCase {
        ...
        public TestCase setNums(int[] nums) {
            this.nums = nums;
            return this;
        }

        public TestCase setExpected(int expected) {
            this.expected = expected;
            return this;
        }

        public TestCase setK(int k) {
            this.k = k;
            return this;
        }
    }
    ...
    public void numSubarrayProductLessThanK() {
        for (TestCase testCase : testCases) {
            int actual = solution.numSubarrayProductLessThanK(testCase.nums, testCase.k);
